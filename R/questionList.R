...
q1Answer <- column(4, h4(textOutput('resultMult1')))
...
q2Answer <- column(4, h4(textOutput('resultMult2')))
...
q5Answer <- column(4, h4(textOutput('resultMult5')))
...
q8Answer <- column(4, h4(textOutput('resultMult8')))
...
q9Answer <- column(4, h4(textOutput('resultMult9')))
...
q10Answer <- column(4, h4(textOutput('resultMult10')))
...
q11Answer <- column(4, h4(textOutput('resultMult11')))
...
q12Answer <- column(4, h4(textOutput('resultMult12')))
...
q13Answer <- column(4, h4(textOutput('resultMult13')))
...
q14Answer <- column(4, h4(textOutput('resultMult14')))

q15Question <- list(15, "Strong negative correlations mean there is almost no correlation.", "True", "False", "None of the above.", "All of the above.")
q15Answer <- column(4, h4(textOutput('resultMult15')))

q16Question <- list(16, "Standardizing variables using the scale() function in R before proceeding with PCA is rarely required.", "True", "False", "None of the above.", "All of the above.")
q16Answer <- column(4, h4(textOutput('resultMult16')))
...
q17Answer <- column(4, h4(textOutput('resultMult17')))
...
q18Answer <- column(4, h4(textOutput('resultMult18')))
...
q19Answer <- column(4, h4(textOutput('resultMult19')))

q20Question <- list(20, "After computing PCA  of your data, you get this table below. What does the first column of numbers represent?", "PC1", "PC2", "PC3", "PC4")
q20Answer <- column(4, h4(textOutput('resultMult20')))

q21Question <- list(21, "Using the table below, which variable(s) strongly correlate with PC2?", "median_income", "population", "children_proportion", "income_ineq")
...
q23Answer <- column(4, h4(textOutput('resultMult23')))
...
q24Answer <- column(4, h4(textOutput('resultMult24')))
